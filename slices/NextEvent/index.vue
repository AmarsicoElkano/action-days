...
<template>
  ...
  >
    ...
    <div class="px-[16px] md:px-[120px] relative flex flex-col items-center justify-center w-full h-full gap-[40px] md:gap-[0]">
      <div class="w-full">
        <h2
          data-title
          class="uppercase text-titleSection_mb md:text-titleSection text-secondary"
        >
          {{ slice.primary.title_1 }}
        </h2>
        <h2
          data-title
          class="uppercase text-titleSection_mb md:text-titleSection text-secondary ml-[60px]"
        >
      ...
      <div class="flex flex-col-reverse md:flex-row gap-[40px] md:gap-[0]">
        <div class="md:w-1/2">
          <div class="md:mt-[135px]">
            <PrismicLink
              class="text-secondary uppercase flex gap-[40px] items-center"
            ...
            >
              ...
              >
                <path
                  d="M25.0019 2L39.2304 16.2286L25.0019 30.4571"
                  stroke="white"
                  stroke-width="2"
