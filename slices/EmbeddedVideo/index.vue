...
<template>
  <section
    id="livesession"
    :ref="setRef"
    data-section="livesession"
    class="pt-[160px] px-[16px] md:px-[120px] pb-[100px]"
    data-nav="dark"
  >
    <div>
      <h1
        data-title
        class="text-titleSection_mb md:text-titleSection uppercase text-primary ml-[60px]"
      >
        {{ slice.primary.title1 }}
      </h1>
      <h1
        data-title
        class="text-titleSection_mb md:text-titleSection uppercase text-primary"
      >
    ...
    <div class="flex flex-col md:flex-row">
      <div class="md:w-1/2 pt-[40px] md:pt-[130px]">
        <p
          data-text
          class="text-primary mb-[40px] md:mb-[0px] md:pr-[120px]"
        >
          {{ slice.primary.text }}
        </p>
      </div>
      <div
        data-item
        class="md:w-1/2 aspect-video bg-primary rounded-xl"
      />
    </div>
  </section>
</template>
