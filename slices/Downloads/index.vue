...
<template>
  <section id="documents" :ref="setRef" class="w-full min-h-screen w-full py-[140px] px-[16px] md:px-[60px]"
    ...
    <div class="max-w-[1300px] m-[auto]">
      ...
      <div class="flex">
        ...
        <div class="md:w-1/2 md:flex gap-[44px]">
          <div v-for="(item, index) in slice.primary.documents" :key="index" class="mb-[40px] md:mb-[0px]" data-item>
