...
<template>
  <section id="documents" :ref="setRef" class="w-full min-h-screen py-[140px] px-[16px] md:px-[60px]" :class="slice.primary.light_background_color ? 'bg-secondary' : 'bg-primary'
    ...
    <div class="max-w-[1300px] m-[auto]">
      <div class="flex flex-col md:flex-row md:items-end w-full mb-[40px] md:mb-[135px]" :class="slice.primary.light_background_color
          ? 'text-primary'
          : 'text-secondary'
        ">
      ...
      <div class="flex flex-wrap md:flex-nowrap gap-20 justify-center md:justify-end"
