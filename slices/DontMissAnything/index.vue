...
<template>
  <section
    class="bg-light w-full h-auto min-h-[900px] py-[80px] relative text-primary overflow-hidden"
  >
    <PrismicImage
      class="absolute top-[-240px] right-0 max-w-[750px] z-0"
      :field="slice.primary.symbol_top_right"
    />
    <PrismicImage
      class="absolute bottom-[-240px] left-0 max-w-[750px] z-0"
      :field="slice.primary.symbol_bottom_left"
    />
      ...
      >
        ...
        >
          <PrismicLink
            ...
            :field="slice.primary.registration_link"
