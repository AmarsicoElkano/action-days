...
<template>
  <section
    :ref="setRef"
    class="w-full h-auto bg-secondary pb-[0px] md:pb-[213px]"
    data-section="agenda"
    data-nav="dark"
  >
        ...
        <div class="md:h-screen relative col-start-6 col-span-12">
          <div ref="masonry" class="masonry md:grid gap-[20px] relative">
            <div class="content text-primary text-download uppercase">
              <div
                class="py-20 md:p-20 md:grid grid-cols-2 md:w-[720px] gap-20"
              >
                <div
                  v-for="(el, idx) in slice.primary.card_group"
                  :key="idx"
                  class="p-[24px] mb-[20px] md:p-20 bg-white w-full max-w-full md:max-w-[330px] h-auto md:h-[22rem] flex flex-col relative box-agenda"
                  :class="idx === 1 ? 'mt-20' : ''"
                  data-item
                >
                  <PrismicLink
                  ...
                  >
                    ...
                    <div class="">
                      <PrismicRichText
                        :field="el.paragraph"
                        :class="el.xl_font_size ? ' text-md' : ' text-base'"
                      />
                    </div>
                  </PrismicLink>
                </div>
