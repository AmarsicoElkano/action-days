...
<template>
  <section id="agenda" :ref="setRef"
    class="bg-secondary text-primary pt-[200px] pb-[0px] md:py-[200px] px-[16px] md:px-[60px]" data-section="agenda"
    data-nav="dark">
    <div class="w-full flex flex-col md:flex-row gap-[40px] md:gap-[60px]">
      <h2 data-title class="w-full md:w-2/3 text-titleSection_mb md:text-titleSection uppercase">
        {{ slice.primary.title }}
      </h2>
      <PrismicRichText style="line-height: 148%;" class="w-full md:w-1/3 md:self-end" data-text
