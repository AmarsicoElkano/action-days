  ...
  >
    <div>
      <div class="md:w-[961px] m-[auto] relative md:top-[50px] z-10 mb-[40px] md:mb-[0px]">
        ...
        <h2
          data-title
          class="w-full uppercase text-titleSection_mb md:text-titleSection md:ml-[180px]"
        >
      ...
      >
        ...
        <div class="md:absolute bottom-[60px] right-[60px] z-40 flex gap-[20px] mt-[26px] justify-center md:justify-end">
