    ...
    <article class="relative bg-primary ">
      ...
      >
        ...
        <div class="text-secondary relative z-10">
          <div class="flex justify-between md:justify-normal md:gap-[126px] md:ml-[56px]">
            <p
              class="text-detail_mb md:text-detail"
              data-subtitle
            >
              {{ home?.data.date }}
            </p>
          ...
          <div>
            ...
            <h1
              class="uppercase text-headline_mb md:text-headline"
              data-title
            >
              {{ home?.data.title_two }}
            </h1>
      ...
      <section
        ...
        data-nav="light"
      >
        <div class="flex flex-col-reverse md:flex-row items-center pt-[100px] md:pt-[0px]">
          <div class="md:w-1/2 pt-[80px] md:pt-[132px]">
            <PrismicImage
          ...
          <div class="md:w-1/2 px-[16px] ml-[84px] md:ml-[0] md:pr-[120px]">
            <PrismicRichText
              data-text
