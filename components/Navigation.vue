...
<template>
  ...
  >
    <LogoWhite
      class="relative md:absolute left-0 top-[10px] px-[16px] md:px-[60px]"
    />

    <div class="max-w-[900px]">
      <img
        class="absolute md:px-[250px] top-0 max-w-full w-full h-auto"
        src="/public/img/menu-ellipse.svg"
      />
    </div>
    ...
    >
      ...
      <div
        class="flex flex-col md:flex-col items-start w-full sm:max-w-[720px]"
      >
        <div
        ...
        >
          <div ref="navItems">
            <PrismicLink
              class="flex items-center border-t-[1px] border-white border-opacity-20 cursor-pointer w-full"
              :field="item.url_link"
            >
              <span class="font-light mt-40">0{{ index + 1 }}</span>
              <span
                class="text-highlight sm:text-titleSection_mb md:text-titleSection_mb pl-20 pt-30"
              >
      ...
      <div
        class="flex flex-col md:flex-col space-y-20 z-20 w-full flex-end max-w-[360px]"
      >
        <PrismicLink :field="navigation.data.pact_link" class=" ">
          ...
          >
            ...
            <img
              class="w-[53px] h-[53px] self-end mb-5"
              src="/public/img/arrow-right-menu.svg"
            />
          </div>
        </PrismicLink>
